...
function staticSitemap() {
  const paths = ['/', '/news', '/entertainment', '/sports', '/business', '/lifestyle', '/trending', '/live', '/about', '/contact', '/privacy', '/privacy-policy', '/terms', '/ethics', '/corrections', '/fact-check', '/advertise', '/careers', '/authors', '/podcast', '/tv', '/energy', '/education', '/finance'];
...
await writeBoth('sitemap-tags.xml', tagsSitemap(posts));
